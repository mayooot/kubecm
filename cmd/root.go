...
func (cli *Cli) setFlags() {
	...
	flags.IntVarP(&uiSize, "ui-size", "u", 7, "number of list items to show in menu at once")
	flags.BoolVarP(&silenceTable, "silence-table", "s", true, "enable/disable output of context table on successful config update")
